...
<template>
  <div class="hello">
    ...
    <p class="h2" style="margin-top: 50px;">These pre-built queries require input</p>
    </div>
    <div>
  <thead>
  <tr>
    <th>See your favorite movies</th>
    <th>See movies given a genre</th>
    <th>Get Details on a Movie from its ID</th>
    <th>See what actors have worked with directors</th>
    <th>See average rating fo a director's movies</th>
  </tr>
</thead>
  <tr>
    ...
    <td><input type="text" v-model="director_rating" placeholder="Director_Name" class="query-boxes">
    <button @click="avgDirectorsMoviesRatings" class="btn btn-success">Execute</button></td>
  </tr>

  <thead>
  <tr>
    <th>See average rating of movies with given actor</th>
    <th>See what awards an actor has won</th>
    <th>See Movies done by a director</th>
    <th>See Movies given a content Rating</th>
  </tr>
</thead>
  <tr>
    <td><input type="text" v-model="user_id"  placeholder="Email" class="query-boxes">
